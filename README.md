 ...
 * It is an important network structure in the study of human systems because it fits many real world networks (both physical and social) very well.  
 ...
 ### Decision-to-move
  * The decision to move (or not-move) is controlled by the parameter __risk-life__. This is a random number from a uniform           distribution between a minimum (0.0) and maximum (1.0).  
