...
### Output
A stack area plots and csv file showing the number of susceptible, exposed, asymptomatic, and symptomatic. of susceptible, infected, and dead, and the number of individuals at hospitals.
